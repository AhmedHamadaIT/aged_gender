...
- **Person Re-Identification (ReID)** — Search for identities across cameras using image uploads; automatic gallery registration during tracking using OSNet.
---
...
#### `POST /reid/search`
Upload an image to find the top **K** similar identities previously registered in the Qdrant vector database. This is used to query the system for a specific person's history across different tracks.

**Parameters (Multipart Form Data)**
* `file`: The image file containing the person to search for (UploadFile).
  ...
  "results": [
    {
      "score": 0.9998,
      "metadata": {
        "image_path": "./gallery/track_114_frame_78.jpg",
        "track_id": 114,
        "frame": 78
      }
    },
    {
      "score": 0.7863,
      "metadata": {
        "image_path": "./gallery/track_191_frame_118.jpg",
        "track_id": 191,
        "frame": 118
      }
    },
    {
      "score": 0.7656,
      "metadata": {
        "image_path": "./gallery/track_114_frame_48.jpg",
        "track_id": 114,
        "frame": 48
      }
    },
    {
      "score": 0.7642,
      "metadata": {
        "image_path": "./gallery/track_191_frame_88.jpg",
        "track_id": 191,
        "frame": 88
      }
    },
    {
      "score": 0.7576,
      "metadata": {
        "image_path": "./gallery/track_211_frame_102.jpg",
        "track_id": 211,
        "frame": 102
      }
    }
...
### 6. Person Re-Identification (OSNet)
  - **Model**: `osnet_x1_0.pt`
  - **Purpose**: Identity retrieval and appearance embedding extraction.
  - **Hardware Performance**:
        * **Latency**: ~51.63 ms (Warm)
        * **VRAM**: ~164 MB
        * **Accuracy**: Rank-1: 94.40%, mAP: 82.60%
...
├── storage/
|   └── identity_manager.py     # Qdrant interface
├── tests/                      # pytest suite (`pytest.ini`)
├── logger/                     # Logging configuration
│   └── logger_config.py        # Logger setup
├── gallery/                    # Saved ReID crop storage
...
| `/docs` | GET | Swagger UI |
| `/redoc` | GET | ReDoc |
| `/reid/search` | POST | Upload image to find similar identities |
